# Exploring-Calculus
Quick Calculus Background Calculus has 2 major components (at least initially)
1. The Derivative
2. The Integral

One motivation for the Derivative is the tangent line.
...
One motivation for the Integral (definite) is the Riemann Sum Process.
...
f(x)=x^2
f(x)=e^x
f(x)=(9−x^2)^.5−A semi-circle of radius 3
